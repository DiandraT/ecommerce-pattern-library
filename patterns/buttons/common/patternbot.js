 ...
 * @version 179e4812f2fb915008fab2905c238a4e9c9b8617
 */
const patternManifest_179e4812f2fb915008fab2905c238a4e9c9b8617 = {
  "commonInfo": {
    "theme": [],
    "readme": {
      "attributes": {},
      "bodyRaw": "The buttons use our accent colour to grab the users attention. There is a significant purpose for all three buttons:\n\n- The regular buttons are for cards, forms and where the background is a light colour\n- The light buttons are for white or dark background areas because it'll create a nice contrast\n- The ghost buttons should be used exclusively on banners where the background is an image\n\nUse the various 'font-size' classes to make different sizes\n",
      "bodyBasic": "The buttons use our accent colour to grab the users attention. There is a significant purpose for all three buttons: - The regular buttons are for cards, forms and where the background is a light colour - The light buttons are for white or dark background areas because it'll create a nice contrast - The ghost buttons should be used exclusively on banners where the background is an image Use the various 'font-size' classes to make different sizes"
    },
    "interfaceColours": {
      "primary": 0,
      "opposite": 255
...
patternBotIncludes(patternManifest_179e4812f2fb915008fab2905c238a4e9c9b8617);
}());